...
gye = LINE('EIJIF89XPlLbYQXQPn19.gzIkOuQ8fcJ+HzNHqfezoq.j0b2yxoihIw0SJ60SclHQuQkIXFEhasGd/LoNTw1v+k=')
gye.log("Auth Token : " + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Channel Token : " + str(channelToken))

ais = LINE('EIoogUluO8c1kVt8Oat9.P1b3iWrd2siq32zyb7EHMq.7BC/UzjwjaQ6/qzIY5gvao6Ojgr1WJWnsJjkKYR5ep0=')
ais.log("Auth Token : " + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Channel Token : " + str(channelToken))

ki2 = LINE('EIjlpNsWXEtS86zAP0S3.r289V5XUsKocrPgbPDRhCW.7xSF7WuU4pg7vqnr9D3A3AHo859HHIGK19L/felkrgY=')
ki2.log("Auth Token : " + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("Channel Token : " + str(channelToken))

ki3 = LINE('EIB6rCtLB9AVrWI7Ab2b.jn9k0zvvZzxZUimhe8LFsW.GYQdj0bV/nfkCi+RUZQ/ymbyuHSX/cKzwGxC/r6/Qqk=')
ki3.log("Auth Token : " + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("Channel Token : " + str(channelToken))

ki4 = LINE('EIKutlNstkApsrkmnFpe.T91wWzzC3lw+noVY0yN23G.El223yWBiCjZ2YJdUT4GHuQ0utApLuSHXbH1vfrsKo4=')
...
Bots = [gyeMID,aisMID,ki2MID,ki3MID,ki4MID] #ini jangan dirubah Gunanya agar bot tidak saling kick
creator = ["u19988aa14abc1428ff8599e140511939"]
Owner = ["u19988aa14abc1428ff8599e140511939"]
admin = ["u19988aa14abc1428ff8599e140511939"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u19988aa14abc1428ff8599e140511939")
                    gye.sendMessage(to,"█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█")
...
#==============================================================================#
                    ...
                    gye.sendContact(to, gyeMID)
                    gye.sendMessage(msg.to,"➲ Semua Bot Hadir Bos")
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"➲ Admin Hadir")
                        ais.sendMessage(msg.to,"➲ Tukang Suntik Hadir")
                        ki2.sendMessage(msg.to,"➲ Tukang Nimbang Hadir")
                        ki3.sendMessage(msg.to,"➲ Yang jaga Kasir Hadir")
                        ki4.sendMessage(msg.to,"➲ Tukang Imunisasi Hadir")
                        gye.sendMessage(msg.to,"➲ Karyawan Posyandu Hadir semua")
